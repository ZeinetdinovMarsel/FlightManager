...
public interface IFederalDistrictService
{
    ...
    Task<IEnumerable<FederalDistrictModel>> GetAllFederalDistricts(string? sortBy = null, bool descending = false, int page = 1, int pageSize = 10, string? namefilter = null);
